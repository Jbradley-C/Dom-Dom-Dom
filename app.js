...
document.addEventListener('DOMContentLoaded', function() {
	...
	button.addEventListener('click', function() {
		...
		div.addEventListener('dblclick', function() {
			if (div.id % 2 === 0) {
				//checking for even id/number withing square
				if (div.nextSibling !== null) {
					//checking to see if the square to right exists
				...
				//This considers the only other option for even/odd
				if (div.previousSibling !== null) {
					//Checks if square to left exists
